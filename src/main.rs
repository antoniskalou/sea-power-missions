...
use mission::{Mission, MissionOptions, TaskforceOptions, WeaponState, UnitOption, FormationOption};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let mission = Mission::new(&unit_db, MissionOptions {
        latlon: (12., 12.),
        size: (100, 100),
        ...
        red: TaskforceOptions {
            ...
            units: vec![
                UnitOption::Random { nation: Some("usn".to_owned()), utype: None }
            ],
            formations: vec![],
        }
    });
